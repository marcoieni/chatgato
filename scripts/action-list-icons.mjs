...
export const actionListIcons = {
  ...
  plan: list(
    line(
      `<path d="M10 1.5v1.25M3.5 8H2m16 0h-1.5M5.25 3.25l-1-1m10.5 1 1-1M10 4.5c-2.2 0-4 1.8-4 4 0 1.35.7 2.5 1.7 3.3.5.4.8 1 .8 1.95h3c0-.95.3-1.55.8-1.95 1-.8 1.7-1.95 1.7-3.3 0-2.2-1.8-4-4-4ZM8.5 16h3m-2.25 2h1.5"/>`,
      1.5,
    ),
  ),
  prompt: list(
