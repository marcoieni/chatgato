...
| Fast mode               | A dedicated **Fast Mode** key toggles Fast mode without submitting composer text, showing gray while off and green while on.                                                         |
| Plan mode               | A dedicated **Plan** key toggles Plan mode without submitting composer text, showing gray while off and purple while on.                                                             |
